...
for i in skill_list:
    if i.是否有伤害 == 1 and i.是否有护石 == 1:
        知源_逐风者护石选项.append(i.名称)

知源_逐风者符文选项 = ['无']
for i in skill_list:
    if i.所在等级 >= 20 and i.所在等级 <= 80 and i.所在等级 != 50 and i.是否有伤害 == 1:
        知源_逐风者符文选项.append(i.名称)
