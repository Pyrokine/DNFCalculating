...
class skill4(主动技能):
    ...
    等级精通 = 50
    基础等级 = min(int((极诣_狂战士等级 - 所在等级) / 学习间隔) + 1, 等级精通)
    数据 = [0, 339, 373, 408, 442, 477, 511, 546, 580, 615, 649, 683, 718, 752, 787, 821, 856, 890, 925, 959, 993, 1028,
          1062, 1097, 1131, 1166, 1200, 1235, 1269, 1303, 1338, 1372, 1407, 1441, 1476, 1510, 1545, 1579, 1613, 1648,
          1682, 1717, 1751, 1786, 1820, 1855, 1889, 1923, 1958, 1992, 2027, 2061, 2096, 2130, 2165, 2199, 2233, 2268,
          2302, 2337, 2371, 2406, 2440, 2475, 2509, 2543, 2578, 2612, 2647, 2681, 2716]
    攻击次数 = 1
    CD = 4.8
    TP成长 = 0.10
    TP上限 = 5
...
for i in skill_list:
    if i.是否有伤害 == 1 and i.是否有护石 == 1:
        极诣_狂战士护石选项.append(i.名称)

极诣_狂战士符文选项 = ['无']
for i in skill_list:
    if i.所在等级 >= 20 and i.所在等级 <= 80 and i.所在等级 != 50 and i.是否有伤害 == 1:
        极诣_狂战士符文选项.append(i.名称)
