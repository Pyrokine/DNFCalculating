...
class 装备1(装备):
    ...
    def 城镇属性(self, character):
        character.attr["技能攻击力"] *= 1.30
        character.attr["百分比三攻"] += 0.38
